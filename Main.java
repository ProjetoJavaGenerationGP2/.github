...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (tipoContrato.equalsIgnoreCase("CLT")) {
			...
			MenuPJ(funcionariopj.getNome(), cargo, funcionariopj.getCnpj(), rescisao);
	...
	private static void Inicial() {
		...
		System.out.printf(Cores.TEXT_BLUE_BOLD, Cores.ANSI_WHITE_BACKGROUND,
				          "");
		System.out.printf("\n  -------------------------------------------  ");
		System.out.printf("\n             CALCULO TRABALHISTA               ");
		System.out.printf("\n        BEM VINDOS A -----                     ");
	...
	private static void MenuPJ(String nome, String cargo, String cnpj, double rescisao) {
