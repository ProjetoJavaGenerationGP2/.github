...
public class Rescisao {
	...
	float salario, saldoSalario,totalProventos=0;
	...
	public Rescisao(String nome, String sInicioTrabalho, String sFimTrabalho, boolean demissaoVoluntario,
			int feirasVencidas, float salario) {
		this.nome = nome;
	...
	public Rescisao(String nome, String sInicioTrabalho, String sFimTrabalho, LocalDate inicioTrabalho,
			LocalDate fimTrabalho, int diasTrabalhados, int diasDoMes, long mesesTrabalhados,
			boolean demissaoVoluntario, int feirasVencidas, LocalDate monthsOfWork, float salario, float saldoSalario) {
		this.nome = nome;
		this.sInicioTrabalho = sInicioTrabalho;
		this.sFimTrabalho = sFimTrabalho;
	...
	public Rescisao(int diasTrabalhados, int diasDoMes, int feirasVencidas, float salario) {
		this.diasTrabalhados = diasTrabalhados;
		this.diasDoMes = diasDoMes;
		this.feirasVencidas = feirasVencidas;
		this.salario = salario;
	...
	public Rescisao(String nome, LocalDate inicioTrabalho, LocalDate fimTrabalho, float salario) {
		super();
		this.nome = nome;
		this.inicioTrabalho = inicioTrabalho;
		this.fimTrabalho = fimTrabalho;
	...
	public Rescisao(float saldoSalario, float ferias, float decimoTerceiro) {
		super();
	}
	...
	public int diasTrabalhados(LocalDate fimTrabalho) {
		return fimTrabalho.getDayOfMonth();
	}

	public int diasDoMes(LocalDate fimTrabalho) {
		return fimTrabalho.lengthOfMonth();
	}

	public long mesesTrabalhados(LocalDate inicioTrabalho,LocalDate fimTrabalho) {
		return ChronoUnit.MONTHS.between(inicioTrabalho, fimTrabalho);
	}
}